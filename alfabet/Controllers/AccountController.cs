...
using alfabet.Models;

namespace alfabet.Controllers {
  [Authorize]
  public class AccountController : Controller {
    ...
    public ActionResult Subscribe() {
      var model = new alfabet.Models.SubscribeViewModel();
      model.Databases = 1;
      model.Features = 1;
      model.Users = 1;
      return View(model);
    ...
    public async Task<ActionResult> Register(RegisterViewModel model) {
      if (ModelState.IsValid) {
        ...
        if (result.Succeeded) {
          ...
          var returnUrl = HttpUtility.ParseQueryString(Request.UrlReferrer.Query)["returnUrl"]; // Request.QueryString.Get("returnUrl");
          if (returnUrl != "")
            return RedirectToLocal(returnUrl);
          else
